...
class {class_name}Orchestrator(BaseBotOrchestrator[Any]):
    ...
    async def render_content(self, payload: Any, director: "Director") -> ViewResultDTO:
        """Content rendering logic. Override to implement feature UI."""
